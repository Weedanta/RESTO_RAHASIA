...
// Pindahkan data ke tabel `rejected_reservations`
$insertStmt = $pdo->prepare("
    INSERT INTO rejected_reservations (name, email, phone, reservation_datetime, people, room_type, payment_method, payment_proof, additional_request)
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
");
$insertStmt->execute([
    $reservation['name'],
