...
$stmt = $pdo->prepare("SELECT * FROM rejected_reservations ORDER BY reservation_datetime DESC");
$stmt->execute();
...
<style>
    ...
    <div class="main-container-reject">
        <h1 class="main-header">Rejected Reservations</h1>
        ...
        <div class="button-container">
            <a href="admin_dashboard.php" class="back-reject">Back</a>
        </div>
    </div>
</body>
</html>